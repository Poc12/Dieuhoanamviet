                        ...
                        <div class="tab-content p-0">
                            <div class="row">
                                ...
                                <div class="col-12 my-2">
                                    ...
                                    <input name="writen_by" value="{{@$obj['writen_by']}}" type="text" class="form-control" placeholder="Vui lòng nhập thông tin">
                                </div>
                                <div class="col-12 my-2">
                                ...
                                <div class="col-12 my-2">
                                    ...
                                    <input name="publisher" value="{{@$obj['publisher']}}" type="text" class="form-control" placeholder="Vui lòng nhập thông tin">
                                </div>
                            </div>
                        </div>
