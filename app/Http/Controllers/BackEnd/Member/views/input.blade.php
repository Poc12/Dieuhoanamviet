                ...
                <div class="card ">
                    ...
                    <div class="card-body form-steps">
                        <div class="tab-content p-0">
                            @if(@$obj['id'])
                                <div class="d-flex">
                                    <label class="form-label ">Mã nhân viên</label><span class="text-info font-bold" style="margin-left: 7px">#{{@$obj['sku']}}</span>
                                </div>
                            @endif
                            <div class="row">
                                @if(!@$obj['id'])
                                    <div class="col-12 my-2">
                                        <label class="form-label">Mã nhân viên</label> <a id="render-code" href="javascript:void(0)">( mã tự động )</a>
                                        <input @if(@$obj) disabled  @endif id="sku" name="sku" value="{{@$obj['sku']}}" type="text" class="form-control" placeholder="Mã nhân viên">
                                    </div>
                                @endif
                                <div class="col-12  my-2">
                                    <label class="form-label">Tên nhân viên</label>
                                    <input name="name" value="{{@$obj['name']}}" type="text" class="form-control" placeholder="Tên nhân viên">
                                </div>
                                <div class="col-12 my-2">
                                    <label class="form-label">Tài khoản/Email</label>
                                    <input name="email" disabled value="{{@$obj['email']}}" type="text" class="form-control" placeholder="Tài khoản">
                                </div>
                                <div class="col-12 my-2">
...
@section('JS')
    <script>
        $('#render-code').click(function () {
            $('#sku').attr('value', random_code())
        })
