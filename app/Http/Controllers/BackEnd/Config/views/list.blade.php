                        ...
                        <div class="tab-content p-0">
                            <div class="row">
                                <div class="col-12 my-2">
                                    ...
                                    <input name="email" value="{{@$obj['email']}}" type="text" class="form-control" placeholder="Email">
                                </div>
                                <div class="col-12 my-2">
                                ...
                                <div class="col-12 my-2">
                                    ...
                                    <input name="facebook" value="{{@$obj['facebook']}}" type="text" class="form-control" placeholder="Facebook">
                                </div>

                                <div class="col-12 my-2">
                                    <label class="form-label">Youtobe</label>
                                    <input name="youtobe" value="{{@$obj['youtobe']}}" type="text" class="form-control" placeholder="Youtobe">
                                </div>

                                <div class="col-12 my-2">
                                    <label class="form-label">Zalo</label>
                                    <input name="zalo" value="{{@$obj['zalo']}}" type="text" class="form-control" placeholder="Zalo">
                                </div>
                            </div>
                        </div>
