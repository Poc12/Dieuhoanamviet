                        ...
                        <div class="tab-content p-0">
                            <div class="row">
                                <div class="col-12 my-2">
                                    ...
                                    <input name="name" value="{{@$obj['name']}}" type="text" class="form-control" placeholder="Tên video">
                                </div>
                                <div class="col-12 my-2">
                                    <label class="form-label">Links</label>
                                    <input id="link" name="link" value="{{@$obj['link']}}" type="text" class="form-control" placeholder="Nhập links video trên youtobe">
                                </div>
                            </div>

                            <div class="col-md-12 ap-videoId">
...
@section('JS')
    <script>
        ...
        function videoId() {
            ...
            let html = `<div class="form-group rm-v">
                     <label for="link">Video Id</label>
                     <input name="video_id" disabled type="text" class="form-control mb-3" id="link" placeholder="Video Id" value="${videoId}">
                     <input name="video_id" type="hidden" class="form-control mb-3" id="link" placeholder="Video Id" value="${videoId}">
             </div>`
            $('.ap-videoId').append(html)
        }
    </script>
@endsection
