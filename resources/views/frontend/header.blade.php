                    ...
                    <div class="col-md-10">
                        <div class="tp-header-welcome d-flex align-items-center">
                           <span>
                            ...
                            <p class="pr-20">Vận chuyển tận nhà 24/24</p>
                            <span>
                            ...
                            <p class="pr-20"><a href="tel:{{@$info['phone']}}">{{@$info['phone']}}</a></p>
                            <span>
                            ...
                            <p class="pr-20"><a href="mailto:{{@$info['email']}}">{{@$info['email']}}</a></p>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="tp-header-top-right d-flex align-items-center justify-content-end">
                            <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                                <div class="tp-header-top-menu-item tp-header-setting">
                                    <span class="tp-header-setting-toggle" id="tp-header-setting-toggle">Danh mục</span>
                                    <ul>
                                        <li>
